...
function(setup_game_executable game_name folder_name)
    ...
    if (WIN32)
        set(SDL_DLL "${CMAKE_SOURCE_DIR}/sdk/sdl/release/SDL3.dll")
        set(SDL_IMAGE_DLL "${CMAKE_SOURCE_DIR}/sdk/sdl_image/release/SDL3_image.dll")
        ...
        if (CMAKE_BUILD_TYPE MATCHES Debug)
            set(SDL_DLL "${CMAKE_SOURCE_DIR}/sdk/sdl/debug/SDL3.dll")
            set(SDL_IMAGE_DLL "${CMAKE_SOURCE_DIR}/sdk/sdl_image/debug/SDL3_image.dll")
